...
@property (nonatomic) OrigoKeysTarget target;
...
/**
* Get the Email ID of the Organization for the key
*
* @return The Email ID of the Organization, or nil if no Email ID was provided when the key was issued.
*/
- (NSString *)emailID;

/**
* Get the Phone Number of the Organization for the key
*
* @return The phone number of the Organization, or nil if no Phone Number was provided when the key was issued.
*/
- (NSString *)phoneNumber;

/**
* Get the Web URL of the Organization for the key
*
* @return The Web URL of the Organization, or nil if no Web URL was provided when the key was issued.
*/
- (NSString *)webURL;

/**
* Get the Font Color of the Organization for the key
*
* @return The Font Color of the Organization, or nil if no Font Color was provided when the key was issued.
*/
- (NSString *)fontColor;
